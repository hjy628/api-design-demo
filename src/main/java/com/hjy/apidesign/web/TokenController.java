package com.hjy.apidesign.web;

import com.hjy.apidesign.annotations.NotRepeatSubmit;
import com.hjy.apidesign.dto.*;
...
public class TokenController {
    ...
    public ApiResponse<AccessToken> apiToken(String appId, @RequestHeader("timestamp") String timestamp, @RequestHeader("sign")String sign){
        ...
        AppInfo appInfo = new AppInfo("1","12345678984724");
    ...
    public ApiResponse<UserInfo> userToken(String username,String password){
        ...
        UserInfo userInfo = new UserInfo(username,"19263487dskjhf9823yr932nfk32iuyre32r","32e98r");
    ...
    public static void main(String[] args) {
        ...
        String signString = timestamp +"1" + "12345678984724";
        String sign = MD5Util.encode(signString);
        System.out.println(sign);

        System.out.println("-------------------------------");
        signString = "password=123456&username=1&12345678984724" + "sign"+timestamp+"A1scr6";
